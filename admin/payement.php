            ...
            <table id="tableau" class="table table-bordered">
                ...
                <tbody>
                  <?php
                    ...
                    try{
                      $stmt = $conn->prepare("SELECT * FROM t_payement
                      ...
                      $stmt->execute();
                      foreach($stmt as $payement){
                          echo "
                          <tr>
                            <td>".$payement['Date']."</td>
                            <td>".$payement['NomClient'].' '.$payement['PostnomClient']."</td>
                            <td>".$payement['Montant']." $</td>
                            <td>
                              <a href='etat_de_sortie/e_facture.php?id=".$payement['CodePayement']."' class='btn btn-success'><i class='fa fa-print'></i> Facture</button>
                            </td>
                          </tr>
                        ";
